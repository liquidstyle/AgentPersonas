...
show_help() {
    echo ""
    echo "Usage: askewniverse-install.sh [OPTIONS]"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  ./askewniverse-install.sh          # Install to current project"
    echo "  ./askewniverse-install.sh -g       # Install globally"
    echo ""
}
...
if [ "$GLOBAL_INSTALL" = true ]; then
    echo -e "  ${YELLOW}./askewniverse-uninstall.sh -g${NC}"
else
    echo -e "  ${YELLOW}./askewniverse-uninstall.sh${NC}"
fi
echo ""
