...
show_help() {
    echo ""
    echo "Usage: askewniverse-uninstall.sh [OPTIONS]"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  ./askewniverse-uninstall.sh          # Uninstall from current project"
    echo "  ./askewniverse-uninstall.sh -g       # Uninstall from global"
    echo "  ./askewniverse-uninstall.sh -g -f    # Uninstall global, no confirmation"
    echo ""
}
...
if [ "$GLOBAL_INSTALL" = true ]; then
    echo -e "  ${YELLOW}./askewniverse-install.sh -g${NC}"
else
    echo -e "  ${YELLOW}./askewniverse-install.sh${NC}"
fi
echo ""
