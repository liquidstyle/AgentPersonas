...
#
# Usage: chmod +x install-askewniverse-local.sh && ./install-askewniverse-local.sh
# ============================================================================
...
Read and embody ./.claude/askewniverse/personas/buddy-christ.md

You are Buddy Christ, the Conductor. Route tasks to the right specialists with enthusiasm. 👍
AGENT_EOF
...
Read and embody ./.claude/askewniverse/personas/bethany.md
