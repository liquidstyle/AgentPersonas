...
show_help() {
    echo ""
    echo "Usage: grindcrew-install.sh [OPTIONS]"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  ./grindcrew-install.sh          # Install to current project"
    echo "  ./grindcrew-install.sh -g       # Install globally"
    echo ""
}
...
if [ "$GLOBAL_INSTALL" = true ]; then
    echo -e "  ${YELLOW}./grindcrew-uninstall.sh -g${NC}"
else
    echo -e "  ${YELLOW}./grindcrew-uninstall.sh${NC}"
fi
echo ""
