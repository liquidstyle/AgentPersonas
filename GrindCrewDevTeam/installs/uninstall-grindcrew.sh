...
show_help() {
    echo ""
    echo "Usage: uninstall-grindcrew.sh [OPTIONS]"
    echo ""
    ...
    echo ""
    echo "Examples:"
    echo "  ./uninstall-grindcrew.sh          # Uninstall from current project"
    echo "  ./uninstall-grindcrew.sh -g       # Uninstall globally"
    echo "  ./uninstall-grindcrew.sh -g -f    # Uninstall globally without confirmation"
    echo ""
}
...
if [ "$GLOBAL_INSTALL" = true ]; then
    echo -e "  ${YELLOW}./install-grindcrew.sh -g${NC}"
else
    echo -e "  ${YELLOW}./install-grindcrew.sh${NC}"
fi
echo ""
